...
public class DynamicTestBeanExtension implements Extension {
    ...
    void forceDiscoveryOfScopelessAlternatives(
        ...
        // Clear state from previous container runs to prevent memory leaks
        collectedInjectionPoints.clear();
        inlineProducerTypes.clear();
    ...
    /** Package prefix of this extension's internal classes (derived, not hardcoded). */
    private static final String ADDON_INTERNAL_PREFIX =
            DynamicTestBeanExtension.class.getPackageName() + ".";
    ...
    private static boolean isInternalType(Class<?> clazz) {
        ...
        return name.startsWith("java.")
                ...
                || name.startsWith(ADDON_INTERNAL_PREFIX);
    }
