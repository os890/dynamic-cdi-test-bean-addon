...
import com.example.myapp.service.NotificationConsumer;

/**
 * Verifies testbean.html snippet 3: multiple @TestBean (repeatable).
 */
@EnableTestBeans
@TestBean(bean = CustomGreeting.class)
@TestBean(bean = CustomNotificationSender.class)
class RepeatableTestBeanSnippetTest {

    @Inject
    NotificationConsumer consumer;

    @Test
    @DisplayName("docs: multiple @TestBean activates both alternatives")
    void bothAlternativesActive() {
