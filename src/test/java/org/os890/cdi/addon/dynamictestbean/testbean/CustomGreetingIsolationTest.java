...
/**
 * Isolation test: activates {@link CustomGreeting} for {@link Greeting}.
 * Runs alongside {@link FormalGreetingIsolationTest} which activates
 * {@link FormalGreeting} for the same type — proving that the JUnit
